...
const MoonCard = () => {
  ...
  useEffect(() => {
    ...
    const todayMoonPhaseData = tarenaMarch2024.find(phase => phase.date === today); // Find the moon phase for today

    const API_ASTRONOMY = 'https://api.astronomyapi.com/api/v2/studio/moon-phase';
const API_ID = 'd7ac534d-9b39-4934-b9fc-cc0f0d8c64fd';
const API_KEY = '76681a9b51264cebd8eddb8c40caa3fc1867efcf9ed844a6c5581376b2abeae97f5fa5e396f02c899b9e19cf9957d90b110c68edacca7164a011cd0dd03160c5ec4438e0b7c7008dd6f3b0a5911cddf20d8620b1470d975fc9f3e45750d1502da6b43008982caf59617b60aadbe08890';
...
<View style={styles.container}>
  {error ? (
    ...
    moonPhaseImage ? (
      <Image source={{ uri: moonPhaseImage }} style={styles.image} />
    ) : (
